...
contract('StabilityPool - Withdrawal of stability deposit - Reward calculations', async accounts => {
  ...
  describe("Stability Pool Withdrawal", async () => {
    ...
    it("withdrawETHGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, whale, MoneyValues._1Be18BN, dec(100000, 'ether'));	
      ...
      // A, B, C open troves
      await th.getCollateralTokenWithApprovalToBO(contracts, alice, MoneyValues._1Be18BN, dec(10000, 'ether'));
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveLUSDAmount(dec(10000, 18)), dec(10000, 'ether'), { from: alice, value: 0 })
	  
      await th.getCollateralTokenWithApprovalToBO(contracts, bob, MoneyValues._1Be18BN, dec(10000, 'ether'));
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveLUSDAmount(dec(10000, 18)), dec(10000, 'ether'), { from: bob, value: 0 })
	  
      await th.getCollateralTokenWithApprovalToBO(contracts, carol, MoneyValues._1Be18BN, dec(10000, 'ether'));
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveLUSDAmount(dec(10000, 18)), dec(10000, 'ether'), { from: carol, value: 0 })
    ...
    it("withdrawETHGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_2, MoneyValues._1Be18BN, dec(100, 'ether'));
    ...
    it("withdrawETHGainToTrove():  Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_3, MoneyValues._1Be18BN, dec(100, 'ether'));
    ...
    it("withdrawETHGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two liquidations of increasing LUSD", async () => {
      ...
      // Defaulters open trove with 200% ICR
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_1, MoneyValues._1Be18BN, '50000000000000000000');
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_2, MoneyValues._1Be18BN, '70000000000000000000');
    ...
    it("withdrawETHGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three liquidations of increasing LUSD", async () => {
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_2, MoneyValues._1Be18BN, '60000000000000000000');
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_3, MoneyValues._1Be18BN, '70000000000000000000');
    ...
    it("withdrawETHGainToTrove(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three varying liquidations", async () => {
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, whale, MoneyValues._1Be18BN, dec(1000000, 'ether'));
      ...
      */
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_1, MoneyValues._1Be18BN, dec(2160, 18));
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_2, MoneyValues._1Be18BN, dec(50, 'ether'));
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_3, MoneyValues._1Be18BN, dec(500, 'ether'));
    ...
    it("withdrawETHGainToTrove(): A, B, C Deposit -> 2 liquidations -> D deposits -> 1 liquidation. All deposits and liquidations = 100 LUSD.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, dennis, MoneyValues._1Be18BN, dec(10000, 'ether'));
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveLUSDAmount(dec(10000, 18)), dec(10000, 'ether'), { from: dennis, value: 0 })
    ...
    it("withdrawETHGainToTrove(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 LUSD.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_4, MoneyValues._1Be18BN, dec(100, 'ether'));
    ...
    it("withdrawETHGainToTrove(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. Various deposit and liquidation vals.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      */
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_2, MoneyValues._1Be18BN, '250000000000000000000');
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_3, MoneyValues._1Be18BN, '50000000000000000000');
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_4, MoneyValues._1Be18BN, dec(400, 'ether'));
    ...
    it("withdrawETHGainToTrove(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. Various deposit and liquidation vals. A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      */
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_2, MoneyValues._1Be18BN, dec(200, 'ether'));
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_3, MoneyValues._1Be18BN, dec(300, 'ether'));
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_4, MoneyValues._1Be18BN, '50000000000000000000');
    ...
    it("withdrawETHGainToTrove(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      // 2 Defaulters open trove with 200% ICR
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_1, MoneyValues._1Be18BN, dec(200, 'ether'));
    ...
    it("withdrawETHGainToTrove(): Depositors withdraw correct compounded deposit after liquidation empties the pool", async () => {
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, erin, MoneyValues._1Be18BN, dec(10000, 'ether'));
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveLUSDAmount(dec(10000, 18)), dec(10000, 'ether'), { from: erin, value: 0 })
    ...
    it("withdrawETHGainToTrove(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, flyn, MoneyValues._1Be18BN, dec(10000, 'ether'));
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveLUSDAmount(dec(10000, 18)), dec(10000, 'ether'), { from: flyn, value: 0 })
	  
      await th.getCollateralTokenWithApprovalToBO(contracts, harriet, MoneyValues._1Be18BN, dec(10000, 'ether'));
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveLUSDAmount(dec(10000, 18)), dec(10000, 'ether'), { from: harriet, value: 0 })
	  
      await th.getCollateralTokenWithApprovalToBO(contracts, graham, MoneyValues._1Be18BN, dec(10000, 'ether'));
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveLUSDAmount(dec(10000, 18)), dec(10000, 'ether'), { from: graham, value: 0 })
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_3, MoneyValues._1Be18BN, dec(200, 'ether'));
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_4, MoneyValues._1Be18BN, dec(200, 'ether'));
    ...
    it("withdrawETHGainToTrove(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_2, MoneyValues._1Be18BN, dec(60, 'ether'));
    ...
    it("withdrawETHGainToTrove(): Several deposits of varying amounts span one scale factor change. Depositors withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_2, MoneyValues._1Be18BN, dec(330, 'ether'));
    ...
    it("withdrawETHGainToTrove(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_2, MoneyValues._1Be18BN, dec(600, 'ether'));
      ...
      // Increasing the price for a moment to avoid pending liquidations to block withdrawal
      await priceFeed.setPrice(dec(200, 18))
      const txA = await th.withdrawFromSPByRequest(contracts, alice, dec(100, 18), web3.currentProvider)
      await priceFeed.setPrice(dec(100, 18))
    ...
    */
    ...
    it("withdrawETHGainToTrove(): 2 depositors can withdraw after each receiving half of a pool-emptying liquidation", async () => {
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, A, MoneyValues._1Be18BN, dec(10000, 'ether'));
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveLUSDAmount(dec(10000, 18)), dec(10000, 'ether'), { from: A, value: 0 })
	  
      await th.getCollateralTokenWithApprovalToBO(contracts, B, MoneyValues._1Be18BN, dec(10000, 'ether'));
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveLUSDAmount(dec(10000, 18)), dec(10000, 'ether'), { from: B, value: 0 })
	  
      await th.getCollateralTokenWithApprovalToBO(contracts, C, MoneyValues._1Be18BN, dec(10000, 'ether'));
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveLUSDAmount(dec(10000, 18)), dec(10000, 'ether'), { from: C, value: 0 })
	  
      await th.getCollateralTokenWithApprovalToBO(contracts, D, MoneyValues._1Be18BN, dec(10000, 'ether'));
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveLUSDAmount(dec(10000, 18)), dec(10000, 'ether'), { from: D, value: 0 })
	  
      await th.getCollateralTokenWithApprovalToBO(contracts, E, MoneyValues._1Be18BN, dec(10000, 'ether'));
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveLUSDAmount(dec(10000, 18)), dec(10000, 'ether'), { from: E, value: 0 })
	  
      await th.getCollateralTokenWithApprovalToBO(contracts, F, MoneyValues._1Be18BN, dec(10000, 'ether'));
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveLUSDAmount(dec(10000, 18)), dec(10000, 'ether'), { from: F, value: 0 })
    ...
    it("withdrawETHGainToTrove(): Large liquidated coll/debt, deposits and ETH price", async () => {
      ...
      const depositors = [alice, bob]
      for (account of depositors) {
        await th.getCollateralTokenWithApprovalToBO(contracts, account, MoneyValues._1Be18BN.mul(toBN('1000')), dec(2, 27));
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_1, MoneyValues._1Be18BN.mul(toBN('1000')), dec(1, 27));
    ...
    it("withdrawETHGainToTrove(): Small liquidated coll/debt, large deposits and ETH price", async () => {
      ...
      const depositors = [alice, bob]
      for (account of depositors) {
        await th.getCollateralTokenWithApprovalToBO(contracts, account, MoneyValues._1Be18BN.mul(toBN('1000')), dec(2, 29));
      ...
      await th.getCollateralTokenWithApprovalToBO(contracts, defaulter_1, MoneyValues._1Be18BN, '5000000000000');
